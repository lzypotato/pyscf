...
#include "m_define_macro.F90" 
  ...
  type(system_vars_t), target :: sv_prds
...
! 
!
subroutine init_sv_libnao_prds(dinp,ninp, size_x) bind(c, name='init_sv_libnao_prds')
  ...
  call sv_get(dinp,ninp, sv_prds)
  call init_size_dft_wf_X(size_x, sv_prds)

end subroutine ! init_sv_libnao_prds

end module !m_sv_libnao_prds
